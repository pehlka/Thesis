...
> do I need to transform these for any reason?
```
...
```{r} 
#Trying to determine if bipedal_side needs to be transformed            DELETE! UNNECESSARY!

#Shapiro-Wilk test
shapiro.test(lab.data$bipedal_side)          #normal
