...
```
# do we want the data to have variance or no?
...
anova(lmer.log.side.vmax.sex)  #not significant

lmer.log.top.vmax.sex <- lmer(log_top_vmax ~ sex + (1 | ID), data = lab.data)
anova(lmer.log.top.vmax.sex)  #not significant
```
...
```{r}
tukey.lmer.log.side.vmax.sex <- emmeans(lmer.log.side.vmax.sex, pairwise ~ sex, adjust="tukey", data=lab.data)
tukey.lmer.log.side.vmax.sex   #not significant
plot(tukey.lmer.log.side.vmax.sex)
```

```{r}
tukey.lmer.log.top.vmax.sex <- emmeans(lmer.log.top.vmax.sex, pairwise ~ sex, adjust="tukey", data=lab.data)
tukey.lmer.log.top.vmax.sex  #not significant
plot(tukey.lmer.log.top.vmax.sex)
```
