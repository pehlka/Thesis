...
ggplot(lab_data2_avg_v_side.reduced, aes(y=side_avg_v, x=substrate_type, fill = biped_combined)) +
  geom_boxplot(outlier.shape = NA) + 
  scale_fill_discrete(labels = c("bipedal", "quadrupedal")) +
...
ggplot(lab_data2_avg_v_side.reduced, aes(y=side_avg_v, x=substrate_type, fill=substrate_type)) +
  geom_boxplot(outlier.shape = NA) + 
  labs(x = "Substrate", y = "Camera 1 Average Velocity (m/s)", title = "Lab Data: Camera 1 Average Velocity vs. Substrate") +
  scale_x_discrete(labels = c("Debris", "Sand", "Mixed")) +
...
lme.top.avgv.sub.tukey  

ggplot(lab_data2_avg_v_top.reduced, aes(y=top_avg_v, x=substrate_type, fill = biped_combined)) +
  geom_boxplot(outlier.shape = NA) + 
  scale_fill_discrete(labels = c("bipedal", "quadrupedal")) +
...
ggplot(lab_data2_avg_v_top.reduced, aes(y=top_avg_v, x=substrate_type, fill=substrate_type)) +
  geom_boxplot(outlier.shape = NA) + 
  labs(x = "Substrate", y = "Camera 2 Average Velocity (m/s)", title = "Lab Data: Camera 2 Average Velocity vs. Substrate") +
  scale_x_discrete(labels = c("Debris", "Sand", "Mixed")) +
  scale_fill_brewer(palette = "Blues") +
