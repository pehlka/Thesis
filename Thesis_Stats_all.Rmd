...
fieldspeed_final_reduced <- read.csv("~/College of Charleston/Thesis/Data/McElroy Habitat Data/fieldspeed_final_reduced.csv")
  #same as fieldspeed_final data except 2 rows were removed that did not have substrate types listed
...
anova(lme(Speed ~ Substrate.Type + Sex, random = ~1|ID, data = fieldspeed_final_reduced, na.action = na.omit))
