...
field_obs_sub <- read.csv("~/College of Charleston/Thesis/Data/Field Transects/Field_Transects_Obstacle_substrate.csv")
  #field transect data - obstacles - broken into substrate type where the obstacles were found
field_obs_type <- read.csv("~/College of Charleston/Thesis/Data/Field Transects/Field_Transects_Obstacle_type.csv")
  #field transect data - obstacles - broken into obstacle type

demo_debris <- read.csv("~/College of Charleston/Thesis/Videos Digitized/Thesis_videos_digitized_condensed_final_2.8.21_demographics_debris.csv")
  #demographics and top performance on debris 
demo_mixed <- read.csv("~/College of Charleston/Thesis/Videos Digitized/Thesis_videos_digitized_condensed_final_2.8.21_demographics_mixed.csv")
  #demographics and top performance on mixed
demo_sand <- read.csv("~/College of Charleston/Thesis/Videos Digitized/Thesis_videos_digitized_condensed_final_2.8.21_demographics_sand.csv")
  #demographics and top performance on sand
demo_debris2 <- read.csv("~/College of Charleston/Thesis/Videos Digitized/Thesis_videos_digitized_condensed_final_2.8.21_demographics_debris_TL.csv")
  #demographics and top performance on debris with lizards mizzing tails removed 
demo_mixed2 <- read.csv("~/College of Charleston/Thesis/Videos Digitized/Thesis_videos_digitized_condensed_final_2.8.21_demographics_mixed_TL.csv")
  #demographics and top performance on mixed with lizards mizzing tails removed 
demo_sand2 <- read.csv("~/College of Charleston/Thesis/Videos Digitized/Thesis_videos_digitized_condensed_final_2.8.21_demographics_sand_TL.csv")
